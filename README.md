...
🐐💬 Error handling of the pagination interrupted this kind of communication by changing the number of ```unique values in communications``` or ```number of items per page```. </br>
